      ...
      <div className="relative z-10">
        ...
        <section id="about" className="max-w-7xl mx-auto px-4 sm:px-6 py-4 md:py-12">
          <div className="w-full md:px-16 md:py-16">
            <h2 className="text-4xl md:text-5xl font-light mb-2 md:mb-8 text-[#7c6714] text-left drop-shadow-lg w-full md:text-center">Perchè affidarci un nuovo lavoro?</h2>
            <p className="font-bold text-xl font-normal mb-2 text-[#7c6714] text-left w-full md:text-center">In un settore ricco di insidie come quello edile il team S.E. Investing ci tiene a distinguersi per correttezza e trasparenza.</p>
